...
#define kPlaybackFileLocation CFSTR("/Users/paul/Desktop/AlmostLover.mp3cc≈")
...
static void MyAQOutputCallback(void *inUserData, AudioQueueRef inAQ, AudioQueueBufferRef inCompleteAQBuffer)
{
    ...
    if (nPackets > 0) {
        ...
        CheckError(AudioQueueStop(inAQ, false), "AduioQueueStop failed");
        aqp->isDone = true;
    }
}
...
int main(int argc, const char * argv[])
{
    @autoreleasepool {
        ...
        CheckError(AudioFileGetProperty(player.playbackFile,
                                        ...
                                        &propSize,
                                        &dataFormat), "Couldn't get file's data formate");
